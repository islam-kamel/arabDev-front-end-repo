...
import { faGithub, faTwitter, faInstagramSquare, faTwitch } from '@fortawesome/free-brands-svg-icons'
            ...
            <div className="d-flex flex-column flex-shrink-0 p-3 bg-light con-left">
              ...
              <ul className="nav nav-pills flex-column mb-auto">
                <li className="nav-item">
                  <a href="#" className="nav-link active list-start" aria-current="page">
                    <svg className="bi pe-none me-2" width="16" height="16"></svg>
                    Home
                  </a>
                </li>
                <li>
                  <a href="#" className="nav-link link-dark list-start">
                    <svg className="bi pe-none me-2" width="16" height="16"></svg>
                    Listings
                  </a>
                </li>
              ...
              <div className="popular">
                <h5 className="list-start mx-3 pt-4">Popular Tags</h5>

                <ul className="nav nav-pills flex-column mb-auto">
                  <li className="nav-item">
                    <a href="#" className="nav-link link-dark list-start" aria-current="page">
                      Home
                    </a>
                  </li>
                  <li>
